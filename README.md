# jhfcm
Jhipster Angular/Spring boot demo app for Firebase cloud messageing integration.

![Jhfcm Demo app](./assets/final-result.png)
...
To build the final jar and optimize the jhfcm application for production, run:
